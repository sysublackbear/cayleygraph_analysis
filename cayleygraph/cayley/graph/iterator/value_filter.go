...
// Optimize There's nothing to optimize, locally, for a value-comparison iterator.
...
// Stats We're only as expensive as our subiterator.
...
// TagResults If we failed the check, then the subiterator should not contribute to the result
