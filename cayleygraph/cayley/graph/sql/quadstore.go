...
func New(typ string, addr string, options graph.Options) (graph.QuadStore, error) {
	...
	if qs.flavor.NoOffsetWithoutLimit {
		qs.opt.NoOffsetWithoutLimit()  // OffsetWithoutLimit
	}
